...
object HermesApiPaths {
    ...
    const val SESSION_DETAIL = "v1/sessions/$" + "sessionId" // v1/sessions/$sessionId
    const val SESSION_ACTIONS = "v1/sessions/$" + "sessionId/actions" // v1/sessions/$sessionId/actions
    const val SESSION_ACTION = "v1/sessions/$" + "sessionId/$" + "action" // v1/sessions/$sessionId/$action
    ...
    const val SKILL_DETAIL = "v1/skills/$" + "skillId" // v1/skills/$skillId
    const val MEMORY = "v1/memory"
    const val MEMORY_DETAIL = "v1/memory/$" + "memoryId" // v1/memory/$memoryId
    const val CRON = "v1/cron"
    const val CRON_DETAIL = "v1/cron/$" + "cronId" // v1/cron/$cronId
